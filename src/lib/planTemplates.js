...
function adjustSets(baseSets, experience) {
    if (experience === "beginner")
        return Math.max(2, baseSets - 1);
    if (experience === "advanced")
        return Math.min(baseSets + 1, 6);
    return baseSets;
}
function makePlanned(exerciseId, goal, experience) {
