...
export function visible(points, threshold = 0.5) {
 ...
 */
export function kneeValgusRatio(lKnee, rKnee, lAnkle, rAnkle) {
 ...
 */
export function limbsOccluded(a, b, xyTol = 0.05, zTol = 0.12) {
