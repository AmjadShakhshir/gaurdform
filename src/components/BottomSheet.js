...
import { Brain, TrendingUp, Clock, ChevronUp, Dumbbell } from "lucide-react";
const TABS = [
...
export function BottomSheet({ workoutContent, coachContent, progressContent, historyContent, closeSignal }) {
